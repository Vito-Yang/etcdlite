...
/**
 * Description: Lease manager for etcd-lite
 */
#ifndef ETCDLITE_LEASE_MANAGER_H
#define ETCDLITE_LEASE_MANAGER_H
...
public:
    ...
    /**
     * @brief Get lease time-to-live
     * @param leaseId The lease ID
     * @param ttl Output remaining TTL
     * @param keys Output attached keys
     * @return Status of operation
     */
    Status TimeToLive(int64_t leaseId, int64_t* ttl, std::vector<std::string>* keys);
    ...
    /**
     * @brief Get keys attached to a lease
     * @param leaseId The lease ID
     * @param keys Output keys
     * @return Status of operation
     */
    Status GetLeaseKeys(int64_t leaseId, std::vector<std::string>* keys);
     ...
     */
    int64_t GetLeaseTTL(int64_t leaseId) const;
...
#endif  // ETCDLITE_LEASE_MANAGER_H
